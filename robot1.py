    ...
    def run(self):
        while self.robot.step(TIME_STEP) != -1:
            if self.is_new_data():
                ...
                if (3.14/2.3<=ph<=(6.28-3.14/2.3))and(ball_data["strength"]>=20)  :
                  #if true(phball,)
                     if (true(ph-3.14,0.1)==0)and fl :
                           e=3.14-ph
                           ct1=PID()
                           self.kp=2
                           self.ki=20
                           ...
                           i=m
                           motor(v,1)
                     elif (true(ph-3.14,0.1)==1)and fl2 :
                           if fl==1 : 
                              p=rp[1]+0.4 
                              fl=0
                           e=p-rp[1]
                  ...
                  if ball_data["strength"] >= strengthdesired-1 :
                       ...
                       if true(phball,0.1)==1 :   
                           e=strengthdesired-ball_data["strength"]
                           ct4=PID()
                           self.kp=2
                           self.ki=20
                           self.kd=0
